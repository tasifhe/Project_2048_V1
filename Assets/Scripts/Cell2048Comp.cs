...
public class Cell2048 : MonoBehaviour
{
    ...
    public Cell2048 up;
    public Fill2048Comp fill;
    private void OnEnable()
    {
        GameControllerComp.slide += OnSlide;
    }
    ...
    private void OnSlide(string whatWasSent)
    {
        ...
        GameControllerComp.ticker++;
        if (GameControllerComp.ticker == 4)
        {
            GameControllerComp.instance.SpawnFill();
        }
    ...
    void CellCheck()
    {
        ...
        Debug.Log("Check");
        GameControllerComp.instance.GameOverCheck();
    }
}